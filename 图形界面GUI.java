...
//     this.setSize(800, 500);//大小(像素)
//     this.setLocation(300,100);//设置窗体的位置，x = 100, y = 200;
...
//     this.setResizable(true);//设置用户不能随意修改大小
//     this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);//设置当窗体关闭时，退出jvm(虚拟机);
//     this.setSize(300, 400);//大小(像素)
//     this.setLocation(1000,200);//设置窗体的位置，x = 200, y = 200;
//     this.setVisible(true);//显示，默认为false
//     
...
//     jsp1 = new JSplitPane (JSplitPane.HORIZONTAL_SPLIT, jl, jl1);//水平拆分HORIZONTAL_SPLIT,竖直拆分VERTICAL_SPLIT
